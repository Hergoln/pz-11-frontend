...
import isNullOrUndefined from "../../global/util/isNullOrUndefined";
      ...
      <AccordionDetails>
        <Box marginBottom={5}>
          ...
          <h3 style={{ fontSize: 16 }}>
            If your input value is out of specified min/max range then it will
            be clipped to fit (e.g. if you input 0 when min is 2 then it will
            set the value to 2 under the hood)
          </h3>
        </Box>
                ...
                (varName: string, index: number) => {
                  ...
                  return (
                    <TableRow key={index}>
                      ...
                      <TableCell>
                        {isNullOrUndefined(variable.min) ? "N/A" : variable.min}
                      </TableCell>
                      <TableCell>
                        {isNullOrUndefined(variable.max) ? "N/A" : variable.max}
                      </TableCell>
